...
(function () {
	...
	if (document.querySelector(".case-page--governance")) {
		var governancePolish = document.createElement("style");
		governancePolish.textContent = ".gov-column--decision{background:#f7f4ed}.gov-column__head h3,.gov-card>strong,.gov-card__top strong,.gov-flow span,.gov-structure h3{text-transform:capitalize}";
		document.head.appendChild(governancePolish);
	}
